...
<style scoped>
    ...
    .cd-disk-nav button:hover,.cd-disk-nav-item:hover{
        color: #5b5bea;
    }
    ...
    .cd-right-head-actions input:focus{
        ...
        -webkit-box-shadow: 0 0 0 2px rgba(91,91,234,.2)!important;
        box-shadow: 0 0 0 2px rgba(91,91,234,.2)!important;
    }
</style>